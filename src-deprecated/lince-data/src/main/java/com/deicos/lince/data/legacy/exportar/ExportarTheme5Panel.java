...
import com.deicos.lince.data.legacy.commands.exportar.ExportarRegistroTheme5;
 ...
 * @author Brais
 */
public class ExportarTheme5Panel extends JPanel {

    public ExportarTheme5Panel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelBotones.add(new JButton(new ExportarRegistroTheme5(seleccionPanel)));
