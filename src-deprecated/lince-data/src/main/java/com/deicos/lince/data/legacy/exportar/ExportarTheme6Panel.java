...
import com.deicos.lince.data.legacy.commands.exportar.ExportarInstrumentoObservacionalTheme;
import com.deicos.lince.data.legacy.commands.exportar.ExportarRegistroTheme6;
 ...
 * @author Brais
 */
public class ExportarTheme6Panel extends JPanel {

    public ExportarTheme6Panel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelBotones.add(new JButton(new ExportarInstrumentoObservacionalTheme(seleccionPanel)));
        panelBotones.add(new JButton(new ExportarRegistroTheme6(seleccionPanel)));
