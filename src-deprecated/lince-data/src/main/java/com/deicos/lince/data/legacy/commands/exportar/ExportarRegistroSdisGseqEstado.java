 ...
 * @author Brais
 */
public class ExportarRegistroSdisGseqEstado extends Command {

    private SeleccionPanel seleccionPanel;

    public ExportarRegistroSdisGseqEstado(SeleccionPanel seleccionPanel) {
        ...
        putValue(Action.ACTION_COMMAND_KEY, "ExportarRegistroSdisGseqEstado");
    ...
    public void execute() {
        ...
        Platform.runLater(() -> {
            ...
            if (f != null) {
                String contenido = Registro.getInstance().exportToSdisGseqEstado(criterios);
