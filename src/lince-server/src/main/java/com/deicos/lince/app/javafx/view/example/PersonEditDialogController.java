 ...
 * @author Marco Jakob
 */
public class PersonEditDialogController extends JavaFXLinceBaseController {
    @FXML
    ...
    private boolean isInputValid() {
        ...
        if (errorMessage.length() == 0) {
            ...
            JavaFXLogHelper.showMessage(AlertType.ERROR, "Invalid Fields", "Please correct invalid fields", dialogStage);
            return false;
        }
    }
}