package com.deicos.lince.transcoding.trials.humble;

/**
 * com.deicos.lince.transcoding.trials.humble
 ...
 * </p>
 * <ul>
 * <li>Demuxers: An { Demuxer} object can read from Media { Container} objects.</li>
 * <li>DemuxerStreams: { DemuxerStream} objects represent Streams of media information inside a { Container}.</li>
 * <li>KeyValueBags: { KeyValueBag} objects are used throughout Humble to represent key-value meta-data stored inside different objects.</li>
 * </ul>
 * <p>
...
/**
    ...
    */
/**
     * Pretty prints a timestamp (in { Global.NO_PTS} units) into a string.
     * @param duration A timestamp in { Global.NO_PTS} units).
