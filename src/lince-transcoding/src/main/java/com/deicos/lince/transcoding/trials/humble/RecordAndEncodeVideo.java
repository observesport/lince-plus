 ...
 * </p>
 * <ul>
 * <li>Muxer: A { Muxer} object is a container you can write media data to.</li>
 * <li>Encoders: An { Encoder} object lets you convert { MediaAudio} or { MediaPicture} objects into { MediaPacket} objects
 * so they can be written to { Muxer} objects.</li>
 * </ul>
 *
 * <p>
...
/** Finally, let's clean up after ourselves. *//*
    ...
    public static void main(String[] args) throws InterruptedException, IOException, AWTException
    {
        ...
        final CommandLineParser parser = new org.apache.commons.cli.DefaultParser();
        try {
