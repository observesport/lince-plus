 ...
 */
@Deprecated
public class ExportarRegistroSdisGseqIntervalo extends Command {

    private SeleccionPanel seleccionPanel;

    public ExportarRegistroSdisGseqIntervalo(SeleccionPanel seleccionPanel) {
        ...
        putValue(Action.ACTION_COMMAND_KEY, "ExportarRegistroSdisGseqIntervalo");
    ...
    public void execute() {
        ...
        Platform.runLater(() -> {
            ...
            if (f != null) {
                String contenido = Registro.getInstance().exportToSdisGseqIntervalo(criterios);
