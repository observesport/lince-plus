...
import com.lince.observer.data.legacy.commands.exportar.ExportarRegistroSdisGseqEventoConTiempo;
 ...
 * @author Brais
 */
public class ExportarSdisGseqEventoConTiempoPanel extends JPanel {

    public ExportarSdisGseqEventoConTiempoPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelBotones.add(new JButton(new ExportarRegistroSdisGseqEventoConTiempo(seleccionPanel)));
