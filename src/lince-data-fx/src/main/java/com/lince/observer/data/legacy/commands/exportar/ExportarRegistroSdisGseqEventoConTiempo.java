 ...
 */
@Deprecated
public class ExportarRegistroSdisGseqEventoConTiempo extends Command {

    private SeleccionPanel seleccionPanel;

    public ExportarRegistroSdisGseqEventoConTiempo(SeleccionPanel seleccionPanel) {
        ...
        putValue(Action.ACTION_COMMAND_KEY, "ExportarRegistroSdisGseqEventoConTiempo");
    ...
    public void execute() {
        ...
        if (criterios.isEmpty()) {
            JOptionPane.showMessageDialog(null, java.util.ResourceBundle.getBundle("i18n.Bundle").getString("SELECCIONE AL MENOS UN CRITERIO.")
        ...
        Platform.runLater(() -> {
            ...
            if (f != null) {
                String contenido = Registro.getInstance().exportToSdisGseqEventoConTiempo(criterios);
