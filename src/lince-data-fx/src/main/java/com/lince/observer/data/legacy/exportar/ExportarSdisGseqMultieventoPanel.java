...
import com.lince.observer.data.legacy.commands.exportar.ExportarRegistroSdisGseqMultievento;
 ...
 */
@Deprecated
public class ExportarSdisGseqMultieventoPanel extends JPanel {

    public ExportarSdisGseqMultieventoPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelBotones.add(new JButton(new ExportarRegistroSdisGseqMultievento(seleccionPanel)));
