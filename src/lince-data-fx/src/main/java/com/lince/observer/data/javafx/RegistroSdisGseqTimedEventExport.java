 ...
 */
public class RegistroSdisGseqTimedEventExport extends GenericExportComponent {

    public RegistroSdisGseqTimedEventExport(UUID observerId) {
        super(observerId);
    }

    @Override
    protected List<Node> getActions(SelectionPanelComponent selectionPanelComponent) {
        Button btnExport = new Button(ResourceBundleHelper.getI18NLabel("EXPORT_SDIS_GSEQ_TIMED_EVENT"));
